...
//            Toast.makeText(context,"Recording Start",Toast.LENGTH_LONG).show();
    ...
    public String stopRecording(){
        try{
            if(recorder != null) {
                isRecording = false;
                Log.d("Hello", "stopRecording: "+getPath(tempWavFile));
                Log.d("Hello1", "stopRecording: ");
                int status = recorder.getState();
                if (status == 1) {
                    recorder.stop();
                }
                Log.d("Hello2", "stopRecording: ");
    ...
    public void playMusic(){
        try{
            ...
            mediaPlayer.setDataSource(getPath(tempWavFile));
            mediaPlayer.prepare();
            mediaPlayer.start();
